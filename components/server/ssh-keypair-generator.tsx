  ...
  return (
    <div className="space-y-3 rounded-md border bg-muted/20 p-4">
      ...
      <div className="flex justify-end">
        <Button htmlType="button" variant="outlined" onClick={handleGenerate} disabled={isGenerating || !canGenerate}>
      ...
      {publicKey ? (
        <div className="space-y-2">
          <div className="flex items-center justify-between gap-2">
            ...
            <Button htmlType="button" size="sm" variant="plain" onClick={() => copyToClipboard(publicKey, 'Public key')}>
      ...
      {privateKey ? (
        <div className="flex justify-end">
          <Button htmlType="button" size="sm" variant="plain" onClick={() => copyToClipboard(privateKey, 'Private key')}>
