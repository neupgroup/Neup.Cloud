  ...
  return (
    <div className="grid gap-6 pb-20">
      ...
      <div className="flex items-center gap-2">
        ...
        {[10, 25, 50].map((option) => (
          <Button key={option} variant={option === perPage ? 'tinted' : 'outlined'} size="sm" asChild>
      ...
      <div className="flex items-center justify-between">
        <Button variant="outlined" size="sm" disabled={currentPage <= 1} asChild={currentPage > 1}>
          {currentPage > 1 ? (
            <Link href={prevHref}>
        ...
        <Button variant="outlined" size="sm" disabled={!hasNextPage} asChild={hasNextPage}>
          {hasNextPage ? (
            <Link href={nextHref}>
