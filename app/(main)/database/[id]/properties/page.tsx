        ...
        <>
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between gap-4 flex-wrap">
              ...
              <Button onClick={handleCheckConnection} variant="outlined" disabled={isChecking || isDeleting}>
          ...
          <Card className="p-4 border-destructive/20 bg-destructive/5">
            <div className="flex items-center justify-between gap-4 flex-wrap">
              ...
              <Button onClick={handleDeleteConnection} variant="solid" disabled={isDeleting || isChecking}>
