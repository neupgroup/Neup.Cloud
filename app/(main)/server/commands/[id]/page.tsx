    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-start gap-4 pt-2">
                ...
                <Button variant="plain" className="text-destructive hover:text-destructive hover:bg-destructive/10" onClick={handleDelete} disabled={isDeleting}>
            ...
            <Dialog open={isRunDialogOpen} onOpenChange={setIsRunDialogOpen}>
                <DialogContent>
                    ...
                    <DialogFooter>
                        <DialogClose asChild><Button htmlType="button" variant="tinted">Cancel</Button></DialogClose>
