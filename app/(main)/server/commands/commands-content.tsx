    ...
    <div className="grid gap-6">
        ...
        <Card className="min-w-0 w-full rounded-lg border bg-card text-card-foreground shadow-sm">
          <div className="p-4 space-y-4">
            ...
            <div className="flex flex-wrap justify-start gap-3">
              ...
              <Button variant="outlined" onClick={handleOpenContinuityTerminal}>
                ...
                {!showDashboard && (
                  <div className="flex justify-start gap-2 p-4 pt-2">
                    {currentCommandPage > 1 && (
                      <Button variant="outlined" onClick={() => updateUrlParams({ page: currentCommandPage - 1 }, 'push')}>
                        Previous
                      </Button>
                    )}
              ...
              {showDashboard ? (
                ...
                <div className="flex justify-start gap-2">
                  {currentHistoryPage > 1 && (
                    <Button variant="outlined" onClick={() => updateUrlParams({ page: currentHistoryPage - 1 }, 'push')}>
                      Previous
                    </Button>
                  )}
      ...
      <Dialog open={isRunDialogOpen} onOpenChange={setIsRunDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            <DialogClose asChild>
              <Button htmlType="button" variant="tinted">
                Cancel
              </Button>
            </DialogClose>
