  ...
  if (isLoading) {
    return (
      <div className="mx-auto max-w-4xl space-y-6 py-10">
        <Button variant="plain" className="w-fit px-0 text-muted-foreground hover:text-foreground" onClick={() => router.push("/server/list")}>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="flex flex-wrap gap-2">
            <Button htmlType="button" variant="outlined" onClick={() => updateExpiration(addExpirationMonths(currentExpiration, 1))} disabled={isExpiring}>Add 1 month</Button>
            <Button htmlType="button" variant="outlined" onClick={() => updateExpiration(addExpirationMonths(currentExpiration, 3))} disabled={isExpiring}>Add 3 months</Button>
            <Button htmlType="button" variant="outlined" onClick={() => updateExpiration(addExpirationMonths(currentExpiration, 6))} disabled={isExpiring}>Add 6 months</Button>
            <Button htmlType="button" variant="outlined" onClick={() => updateExpiration(addExpirationMonths(currentExpiration, 12))} disabled={isExpiring}>Add 1 year</Button>
          </div>
        ...
        <CardFooter className="justify-end border-t px-6 py-4">
          <ConfirmDialog
            trigger={<Button htmlType="button" variant="solid" disabled={isExpiring}><ShieldAlert className="mr-2 h-4 w-4" />Expire</Button>}
      ...
      <Card>
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col gap-2 border-t px-6 py-4 sm:flex-row sm:justify-between">
            <ConfirmDialog
              trigger={<Button htmlType="button" variant="solid" className="w-full sm:w-auto"><ShieldAlert className="mr-2 h-4 w-4" />Expire now</Button>}
              title="Expire this server?"
            ...
            <div className="flex flex-col gap-2 sm:flex-row">
              <Button htmlType="button" variant="plain" onClick={() => router.push("/server/list")}>Cancel</Button>
