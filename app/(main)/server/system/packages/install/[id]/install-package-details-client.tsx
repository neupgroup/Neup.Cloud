...
import { cn } from '@neup/core/utils'; // Correct import path assuming this file is deep
                        ...
                        versions.map((ver, i) => (
                            <Card key={i} className={cn("transition-colors hover:bg-muted/30", ver.version === currentVersion && "border-green-200 bg-green-50/30 dark:bg-green-900/10")}>
                                <CardContent className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    ...
                                    <div>
                                        {ver.version === currentVersion ? (
                                            <Button variant="plain" disabled size="sm" className="w-full sm:w-auto">Installed</Button>
                                        ) : (
                                            <Button
                                                variant="outlined"
                                                size="sm"
